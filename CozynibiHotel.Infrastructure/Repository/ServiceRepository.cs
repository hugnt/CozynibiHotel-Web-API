...
namespace CozynibiHotel.Infrastructure.Repository
{
    public class ServiceRepository : GenericRepository<Service>, IServiceRepository
    {
        ...
        public ServiceRepository(AppDbContext dbContext, IMapper mapper) : base(dbContext)
        {
        ...
        public bool SetDelete(int id, bool isDelete)
        {
            try
            {
                var selectedRecord = _dbContext.Services.Find(id);
        ...
        public ICollection<ServiceDto> Search(string field, string keyWords)
        {
            var all = _mapper.Map<List<ServiceDto>>(GetAll());
